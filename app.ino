...
<!DOCTYPE HTML><html><head>
  <title>ESP Input Form To Nokia</title>
...
void setup() {
  ...
  int n = ipStatus.length() + 1;
  char charArray[n + 1];
  ipStatus.toCharArray(charArray, n);
  LCDClear();
  LCDString("IP Address: ");
  LCDString(charArray);
...
void loop() {
  LCDClear();
  int n = inputNokia.length() + 1;
  Serial.println(inputNokia);
  char charArray[n + 1];
  inputNokia.toCharArray(charArray, n);
  LCDString(charArray);
  delay(2000);
}
